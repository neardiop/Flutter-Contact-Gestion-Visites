...
class PastVisit extends StatefulWidget {
  PastVisit({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _PastVisitState createState() => _PastVisitState();
}

class _PastVisitState extends State<PastVisit> {
